...
@section('content')
    ...
    @if ($comments->lastPage() < $comments->currentPage())
        <script>
            window.location = "/article/{{ $article->id }}?page={{ $comments->lastPage() }}";
        </script>
        @php
            exit();
        @endphp
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="gaming-library">
                                ...
                                <div class = "article" style="position: relative">
                                    ...
                                    <div class="article__footer" style="margin-bottom: 20px">
                                        ...
                                        <form style="display:inline" method="post" action="{{ route('like.store') }}">
                                            ...
                                            <button
                                                style="{{ $article->is_liked_count > 0 ? 'color: #ec6090;' : 'color: #666;' }}font-size: 14px;position: absolute;right: 0;bottom: 15px;"
                        ...
                        <div class="gaming-library">
                            <div>
                                @if ($comments->count() < 1)
                                    <div style="color: rgb(215, 215, 215);text-align:center;font-size: 26px;">
                                ...
                                <div>
                                    ...
                                    {{ $comments->withPath("{$article->id}")->links() }}
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="top-downloaded">
                        <div class="heading-section">
                            <h4 class = "col-lg-4">Похожие <em>Новости </em></h4>
                        </div>
                        <ul>
                            @foreach ($relatedPosts as $article)
                                <a href="{{ route('article.show', $article->id) }}" class = "article"
                                    ...
                                    <div class="article__image" style = "max-height: 200px">
                                        ...
                                        <div class="article__title" style = "font-size:14px">{{ $article->title }}</div>
